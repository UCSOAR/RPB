...
constexpr uint8_t TASK_AIRBRAKES_PRIORITY = 2;             // Priority of the CAM task
constexpr uint8_t TASK_AIRBRAKES_QUEUE_DEPTH_OBJS = 10;    // Size of the cam task queue
constexpr uint16_t TASK_AIRBRAKES_STACK_DEPTH_WORDS = 512; // Size of the cam task stack
